...
def landlord_dashboard(request):
        ...
        return render(request,'dashboard/landlord_daskboard.html',{'form':form,'user_flats':user_flats})
@login_required
def boarder_dashboard(request):
    ...
    return render(request,'dashboard/boarder_daskboard.html',{'all_flats':all_flats,'form':form})
